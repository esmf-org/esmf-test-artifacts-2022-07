build time -- 2022-07-18 07:13:21
...
ESMF_APPSDIR=/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/apps/appsg/Linux.intel.64.mpiuni.default
ESMF_LIBSDIR=/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default -L/apps/netcdf/4.6.1/intel/16.1.150/lib -L/apps/netcdf/4.6.1/intel/16.1.150/lib -L/apps/netcdf/4.6.1/intel/16.1.150/lib 
ESMF_F90ESMFLINKPATHS=-L/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/src/include  -I/apps/netcdf/4.6.1/intel/16.1.150/include -I/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/src/Infrastructure/stubs/mpiuni -I/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/src/prologue/yaml-cpp/include
...
ESMF_CXXLINKPATHS=-L/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default -L/apps/netcdf/4.6.1/intel/16.1.150/lib -L/apps/netcdf/4.6.1/intel/16.1.150/lib -L/apps/netcdf/4.6.1/intel/16.1.150/lib -L/apps/intel/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib -Wl,-rpath,/apps/netcdf/4.6.1/intel/16.1.150/lib -Wl,-rpath,/apps/intel/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/lib/libg/Linux.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias
ESMF_INTERNAL_MPIRUN="/scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias/src/Infrastructure/stubs/mpiuni/mpirun"

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch1/NCEPDEV/stmp2/role.esmfmaint/intel_18.0.5a_mpiuni_g_feature_named-alias
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
