...
export ESMF_DIR=/work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_O_feature_named-alias
...
ssh Orion-login-1.HPC.MsState.Edu /work/noaa/da/mpotts/sandbox/gfortran_8.3.0_openmpi_O_feature_named-alias/runpython.sh 2>&1 | tee python_build.log
