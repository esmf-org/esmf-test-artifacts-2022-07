...
export ESMF_DIR=/work/noaa/da/mpotts/sandbox/intel_2020.2_intelmpi_O_feature_named-alias
...
ssh Orion-login-1.HPC.MsState.Edu /work/noaa/da/mpotts/sandbox/intel_2020.2_intelmpi_O_feature_named-alias/runpython.sh 2>&1 | tee python_build.log
