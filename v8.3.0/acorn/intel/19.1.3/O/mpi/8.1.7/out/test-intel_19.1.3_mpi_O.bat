...
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_v8.3.0
...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_v8.3.0
...
ssh alogin02 /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_v8.3.0/runpython.sh 2>&1 | tee python_build.log
