...
cd /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpi_O_v8.3.0
...
ssh alogin02 /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpi_O_v8.3.0/runpython.sh 2>&1 | tee python_build.log
